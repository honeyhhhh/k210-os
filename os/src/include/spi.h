...
//                                 spi_chip_select_t chip_select,
//                                 const uint32_t *cmd_buff, uint64_t cmd_len, const uint8_t *tx_buff, uint64_t tx_len);
...
//                        const uint32_t *tx_buff, uint64_t tx_len);
 ...
 * @return      Void
 */
// void spi_slave_config(uint8_t int_pin, uint8_t ready_pin, dmac_channel_number_t dmac_channel, uint64_t data_bit_length, uint8_t *data, uint32_t len, spi_slave_receive_callback_t callback);
